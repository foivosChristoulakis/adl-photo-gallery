...
<#list photosNames as photo>
 	           <div data-src="${event}/${photographerName}/${photo}" class="col-lg-3 col-md-6 mb-4">
   	             <div class="card">
   	                 <div class="card-img-top">
  	                      <div class="hovereffect">
  	                          <img class="card-img-top" src="${event}/${photographerName}_thumbs/thumb-${photo}" alt="">
  	                          <div class="overlay">
  	                              <a class="info" href="${event}/${photographerName}/${photo}">View</a>
  	                          </div>
  	                      </div>
  	                  </div>
  	              </div>
